...
# Use colorblind-friendly colormap (e.g., "viridis")
cross_table.plot(kind='bar', stacked=True, colormap='viridis', edgecolor='black')
...
plt.savefig('publication_figure_colorblind.png', dpi=300, bbox_inches='tight')
